...
author: "Prepared by: STA302 Teaching Team"
output: pdf_document
...
Produce descriptive statistics for `train1` and `test1` using `describe()`. Afterwards, please comment out the lines of code producing the descriptive statistics, as they may cause issues with MarkUs.

```{r}
# produce descriptive statistics for train1, then comment out your code.


# produce descriptive statistics for test1, then comment out your code.
